...
export function Visit() {
  return (
    <section
      id="visit"
      className="py-20 md:py-24 bg-gusi-charcoal text-gusi-ivory bg-texture-dark border-t border-gusi-gold/10"
    >
      <div id="reservations" className="container mx-auto px-6 max-w-2xl scroll-mt-20">
        <motion.div
        ...
        >
          ...
          {/* Hours */}
          <div className="mb-12 sm:mb-16 pt-10 sm:pt-12 border-t border-gusi-gold/10">
            <h3 className="text-gusi-gold uppercase tracking-[0.25em] text-[11px] sm:text-xs mb-4 sm:mb-5">
              Hours
            </h3>
            <dl className="font-light text-gusi-porcelain/80 space-y-2 inline-block text-left">
              <div className="flex items-baseline gap-4">
                <dt className="text-gusi-porcelain/60 text-sm w-24 shrink-0">Mon–Fri</dt>
                <dd>{HOURS.weekday}</dd>
              </div>
              <div className="flex items-baseline gap-4">
                <dt className="text-gusi-porcelain/60 text-sm w-24 shrink-0">Sat &amp; Sun</dt>
                <dd>{HOURS.weekend}</dd>
              </div>
              <div className="flex items-baseline gap-4">
                <dt className="text-gusi-porcelain/60 text-sm w-24 shrink-0">Brunch</dt>
                <dd>
          ...
          <div className="pt-10 sm:pt-12 border-t border-gusi-gold/10">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 uppercase tracking-[0.2em] text-xs text-gusi-gold">
